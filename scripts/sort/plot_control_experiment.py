...
samples = 1000
t_fin = 15
file_label = 'z_motion_slow_motors'
...
plt.step(t, desired_pos[:,0], linestyle='--', lw = 1.6, color= 'black', alpha = 0.6, zorder =-1)
plt.step(t, desired_pos[:,1], linestyle='--', lw = 1.6, color= 'black', alpha = 0.6, zorder =-1)
plt.step(t, desired_pos[:,2], linestyle='--', lw = 1.6, color= 'black', alpha = 0.6, zorder =-1)
# plt.grid()
plt.grid(True)
plt.legend()
plt.xlim(0, t_fin)
